...
def seed_missing_products(apps, schema_editor):
...
def unseed_missing_products(apps, schema_editor):
    Product = apps.get_model("inventory", "Product")
...
class Migration(migrations.Migration):
    dependencies = [
        ("inventory", "0003_seed_demo_products"),
    ]

    operations = [
        migrations.RunPython(seed_missing_products, unseed_missing_products),
    ]
